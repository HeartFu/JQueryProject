    ...
    */
    Tablet.prototype.setCanvasWH = function (width, height){
        ...
        if(!width || !height){
            ...
            this.height = (height - $tabletBtns.outerHeight() - bt- bb) * 0.75;
        }
    ...
    */
    Tablet.prototype.buildTablet = function() {
        ...
        html += '<div class="-tablet ' + flex + this.config.extraClass + '" id="' + this.id + '">';
            ...
            html += '    <div>';
            html += this.config.titleHtml ? this.config.titleHtml : ''
            html += '    </div>';
            ...
            // html += this.config.clearBtnHtml && this.config.clearBtnHtml !== '' ? this.config.clearBtnHtml : '清屏';
            // html += '        </div>';
